package com.sailfish.server.protocol.yunkuaichong.v150.checksum;
...
public class YkcCrcCalculator extends AbstractCrcCalculator implements CrcCalculator {
    ...
    private static final byte[] CRC_LO = {
    ...
    public int calculate(byte[] data) {
        ...
        for (byte b : data) {
            iIndex = (ucCRCLo ^ b) & 0x00ff;
            ucCRCLo = ucCRCHi ^ CRC_HI[iIndex];
            ucCRCHi = CRC_LO[iIndex];
        }
    ...
    @Override
    public byte[] crcToBytesArray(int value) {
